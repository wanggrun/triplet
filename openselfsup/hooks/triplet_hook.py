...
class TripletHook(Hook):
    """Hook for Triplet.

    This hook includes momentum adjustment in Triplet following:
    ...
    def before_train_iter(self, runner):
        assert hasattr(runner.model.module, 'momentum'), \
            "The runner must have attribute \"momentum\" in TripletHook."
        assert hasattr(runner.model.module, 'base_momentum'), \
            "The runner must have attribute \"base_momentum\" in TripletHook."
